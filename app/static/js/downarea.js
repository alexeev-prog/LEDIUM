...
var DownArea = (function () {
    ...
    DownArea.prototype.createElements = function () {
        ...
        if (this.hiddenTools.indexOf('heading') < 0) {
            ...
            headingTool.title = 'Заголовок';
            headingTool.innerText = 'Заголовок';
            ...
            headingDropdown.innerHTML = "<ul class=\"heading-list\">\n                            <li data-action=\"heading-1\">Первый уровень</li>\n                            <li data-action=\"heading-2\">Второй уровень</li>\n                            <li data-action=\"heading-3\">Третий уровень</li>\n                            <li data-action=\"heading-4\">Четвертый уровень</li>\n                            <li data-action=\"heading-5\">Пятый уровень</li>\n                            <li data-action=\"heading-6\">Шестой уровень</li>\n                        </ul>";
        ...
        if (this.hiddenTools.indexOf('bold-italic') < 0) {
            ...
            boldItalicTool.title = 'Жирный курсив';
        ...
        if (this.hiddenTools.indexOf('link') < 0) {
            ...
            linkDropdown.innerHTML = "<ul>\n                            <li data-action=\"normal-link\">Обычная</li>\n                            <li data-action=\"quick-link\">Быстрая</li>\n                            <li data-action=\"email\">Email</li>\n                        </ul>";
        ...
        if (this.hiddenTools.indexOf('u-list') < 0) {
            ...
            unorderedListTool.title = 'Маркированный список';
        ...
        if (this.hiddenTools.indexOf('o-list') < 0) {
            ...
            orderedListTool.title = 'Упорядоченный список';
        ...
        if (this.hiddenTools.indexOf('sl-code') < 0) {
            ...
            singleLineCodeTool.title = 'Одно строковый блок кода';
        ...
        if (this.hiddenTools.indexOf('code-block') < 0) {
            ...
            codeBlockTool.title = 'Многостроковый блок кода';
    ...
    DownArea.prototype.addLink = function (self, type) {
        ...
        if (type === 0) {
            ...
            if (self.textarea.selectionStart != self.textarea.selectionEnd) {
                ...
                link = rangeIsURL ? "[](" + range.trim() + ")" : "[" + range.trim() + "](https://)";
